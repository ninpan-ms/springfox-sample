...
# ==== Resource Group ====
export SUBSCRIPTION=b46590cb-a111-4b84-935f-c305aaf1f424 # customize this
export RESOURCE_GROUP=ninpan # customize this
export REGION=eastus

# ==== Service and App Instances ====
export SPRING_CLOUD_SERVICE=ninpan-1217 # customize this
...
export MYSQL_SERVER_FULL_NAME=${MYSQL_SERVER_NAME}.sqltest-eg1.mscds.com
